    ...
    <>
      ...
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          ...
          <h1 className="text-5xl lg:text-4xl md:text-3xl sm:text-2xl font-bold text-slate-200 filter drop-shadow-lg">
            {title}
          </h1>
          <p className="xl:text-sm my-4 text-slate-200">{text}</p>
          <a
            href={url}
          ...
          >
            <button
              type="button"
              className="button-theme bg-slate-200 shadow-slate-900 text-slate-900 py-1.5"
            >
              {btn}
            </button>
          </a>
